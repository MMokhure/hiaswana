      ...
      <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
          ...
          <nav id="navmenu" class="navmenu">
              <ul>
                  ...
                  <li class="dropdown"><a href="#"><span>What We Treat</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                      <ul>
                          ...
                          <li class="dropdown"><a href="#"><span>Neurological Conditions</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                              <ul>
                                  <li><a href="#">Neuropathy</a></li>
                              </ul>
                          </li>
                  ...
                  <li class="dropdown"><a href="#"><span>What Makes Us Different</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                      <ul>
                          ...
                          <li><a href="appointment.html">Neuropathy Treatment</a></li>
                      </ul>
                  </li>
                  <li><a href="doctors.html">Testimonials & Videos</a></li>

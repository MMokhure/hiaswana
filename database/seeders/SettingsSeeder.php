...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            // Contact page
            ['group' => 'pages',    'key' => 'page_contact_intro',               'label' => 'Contact Page Intro',                 'value' => 'Get in touch with the HIASWANA team for membership, partnership, or general enquiries.',   'type' => 'textarea', 'sort_order' => 80],
            ['group' => 'pages',    'key' => 'page_contact_form_heading',        'label' => 'Contact Form Heading',               'value' => 'Send Us a Message',                                                                         'type' => 'text',     'sort_order' => 81],
            ['group' => 'pages',    'key' => 'page_contact_form_subtext',        'label' => 'Contact Form Sub-text',              'value' => "If you have questions or need advice, send us a message and we'll reply within one business day.",                                                                   'type' => 'textarea', 'sort_order' => 82],
        ];
